...
import { 
  AppBar, Toolbar, Box, CssBaseline, Typography, Drawer, List, 
...
              }}
              className={`sidebar-list-item ${isActive(item.path) ? 'active' : ''}`}
            >
              <ListItemIcon className={isActive(item.path) ? 'icon-active' : 'icon-default'}>
                {item.icon}
              </ListItemIcon>
